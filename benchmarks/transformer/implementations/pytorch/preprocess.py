...
def main(unused_argv):
  ...
  test_files = ['/mnt/isilon/DeepLearning/database/mlperf/v0.6/newstest2014.en', '/mnt/isilon/DeepLearning/database/mlperf/v0.6/newstest2014.de']
...
if __name__ == "__main__":
  ...
  #mlperf_log.BENCHMARK_ROOT_DIR = os.path.dirname(os.path.realpath(__file__))
